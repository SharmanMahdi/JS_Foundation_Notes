...
// 4. Calculate the total annual income of the person by extracting the numbers from the following text. 'He earns 5000 euro from salary per month, 10000 euro annual bonus, 15000 euro online courses per month.'
    ...
    // Solutions for Level 2 Exercises:
...
const exactType = Number(typeCheck);
console.log(typeof exactType);
const num = parseFloat('9.8');
console.log(Math.ceil(num) === 10);
console.log('on'.includes('on') && 'jargon'.includes('on'));
...
const longSentence = 'You cannot end a sentence with because because because is a conjunction';
...
const loveCount = (loveSentence.match(/love/g) || []).length;
console.log(loveCount);
const becauseSentence = 'You cannot end a sentence with because because because is a conjunction';
const becauseCount = (becauseSentence.match(/because/g) || []).length;
...
const cleanedSentence = messySentence.replace(/[%$@&#;!]/g, '');
...
const totalAnnualIncome = (incomeNumbers[0] + incomeNumbers[2]) * 12 + incomeNumbers[1];
console.log(totalAnnualIncome);



// Solutions for Level 2 and Level 3 Exercises can be found in Day02_Datatypes.js file.
